<x-dashboard-scope title='Villes'>
    <style>
                              ...
                              <td>
                                <div class="dropdown">
                                  ...
                                  <ul class="dropdown-menu">
                                     <li><a class="dropdown-item" href="{{route('dashboard-cities.update',$city->id)}}">Modifier</a></li>
                                    <li>

                                      <form action="{{route('dashboard-cities.destroy',$city->id)}}" method="POST">
                                        @csrf
                                        @method('delete')
                                        <button class="dropdown-item delete-btn delete-btn">Supprimer</button>
                                      </form>
                                    </li>
                                  </ul>
                                </div>
